# [Check Equal Arrays](https://www.geeksforgeeks.org/problems/check-if-two-arrays-are-equal-or-not3847/1?page=1&category=Sorting&difficulty=Basic,Easy&sortBy=submissions)
## Easy
