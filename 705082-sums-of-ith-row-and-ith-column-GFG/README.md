# [Sums of i-th row and i-th column](https://www.geeksforgeeks.org/problems/sums-of-i-th-row-and-i-th-column3054/1)
## Easy
...
Input: mat[][] = [[1, 4, 2], [6, 1, 3]]Output: false Explaination: Sum of the first row and first column are equal, but the sum of the second row is 10 which is not equal to the sum of the second column which is 5.
Constraints:1 ≤ n, m ≤ 103&nbsp; &nbsp;0 ≤ mat[i][j] ≤ 103&nbsp;