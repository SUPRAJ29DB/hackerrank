# [Maximum number of zeroes](https://www.geeksforgeeks.org/problems/maximum-number-of-zeroes4048/1)
## Easy
...
Expected Time Complexity: O(n*log10(max(arr[i])).&nbsp;Expected Auxiliary Space: O(1).
Constraints:1 ≤ arr.size() ≤ 1051 &lt; arr[i] &lt; 10100